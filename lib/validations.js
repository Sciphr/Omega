import { z } from 'zod'
import { TOURNAMENT_FORMAT, PARTICIPATION_TYPE, SEEDING_TYPE, MATCH_FORMAT, GAME_TEMPLATES } from './types'
...
export const createTournamentSchema = z.object({
  ...
  description: z.string()
    ...
    .optional(),
  game: z.enum(Object.keys(GAME_TEMPLATES)),
  ...
  settings: z.object({
    ...
    checkInDeadline: z.date().optional(),
